...
function validatedob() {
    ...
    if (dob == 'select'){
        dateError.innerHTML = 'select date time';
        return false;
    }else if (dob == 'select') {
        dateError.innerHTML = 'Select any one';
        return false;
    }else {
        dateError.innerHTML = '<i class="fas fa-check-circle"></i>';
        return true;
    }
}
...
function validateForm() {
    if (!validateName() || !validatePhone() || !validateEmail() || !validatePassword || !validateMessage() || !validatelanguage() || !validationdob()) {
        ...
        passwordError.innerHTML = 'password is required'
        messageError.innerHTML = 'message is requiread'
        genderError.innerHTML = 'not select'
        languageError.innerHTML = 'select any one'
        stateError.innerHTML = 'select any one'
